...
export const maintenanceRequests: MaintenanceRequest[] = [
  { id: 'req-1', subject: 'Grinding noise from main spindle', equipmentId: 'equip-1', assignedTechnicianId: 'user-3', dueDate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(), status: 'New', requestType: 'Corrective', teamId: 'team-1', notes: 'Operator reported unusual noise during operation.' },
  { id: 'req-2', subject: 'Robot arm not gripping properly', equipmentId: 'equip-2', assignedTechnicianId: 'user-4', dueDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), status: 'In Progress', requestType: 'Corrective', teamId: 'team-2', duration: 4 },
  { id: 'req-3', subject: 'Quarterly lubrication and check-up', equipmentId: 'equip-3', assignedTechnicianId: 'user-7', dueDate: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(), status: 'New', requestType: 'Preventive', scheduledDate: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(), teamId: 'team-1' },
  { id: 'req-4', subject: 'Network switch unresponsive', equipmentId: 'equip-4', assignedTechnicianId: 'user-5', dueDate: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(), status: 'In Progress', requestType: 'Corrective', teamId: 'team-3' },
  { id: 'req-5', subject: 'Final inspection before disposal', equipmentId: 'equip-5', assignedTechnicianId: 'user-3', dueDate: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), status: 'Scrap', requestType: 'Corrective', teamId: 'team-1', notes: 'Engine failed, beyond repair.' },
  { id: 'req-6', subject: 'Filter replacement (Annual)', equipmentId: 'equip-6', assignedTechnicianId: 'user-8', dueDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString(), status: 'New', requestType: 'Preventive', scheduledDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString(), teamId: 'team-2' },
  { id: 'req-7', subject: 'Hydraulic fluid leak', equipmentId: 'equip-1', assignedTechnicianId: 'user-7', dueDate: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), status: 'In Progress', requestType: 'Corrective', teamId: 'team-1' },
  { id: 'req-8', subject: 'Completed software update', equipmentId: 'equip-4', assignedTechnicianId: 'user-10', dueDate: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), status: 'Repaired', requestType: 'Preventive', teamId: 'team-3', duration: 2, notes: 'Firmware updated to v3.1.4' },
];
